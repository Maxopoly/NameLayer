...
public class ChatStrings {
	...
	public final static String chatNowIgnoring = ChatColor.GREEN + "You are now ignoring ";

	public final static String chatStoppedIgnoring = ChatColor.GREEN + "You stopped ignoring ";
	...
	public final static String defaultGroupNotFound = ChatColor.RED + "Could not find your default group.";

	public final static String chatMessageNotSent = ChatColor.RED + "Could not send that message!";

	public final static String chatRecipientNowOffline = ChatColor.GOLD + "The player you were chatting with has gone offline.";
