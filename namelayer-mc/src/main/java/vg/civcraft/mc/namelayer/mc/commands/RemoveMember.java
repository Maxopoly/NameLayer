...
import vg.civcraft.mc.namelayer.mc.rabbit.playerrequests.RabbitRemoveMember;
...
public class RemoveMember extends StandaloneCommand {
	...
	public boolean execute(CommandSender sender, String[] args) {
		...
		ArtemisPlugin.getInstance().getRabbitHandler().sendMessage(new RabbitRemoveMember(player.getUniqueId(), group, targetPlayer));
		return true;
	}
