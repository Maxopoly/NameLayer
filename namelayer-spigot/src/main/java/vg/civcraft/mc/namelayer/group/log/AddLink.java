...
public class AddLink extends LoggedGroupAction {
	...
	public AddLink(long time, UUID player, boolean isSource, String ownRank, String otherGroup, String otherGroupRank) {
		super(time, player);
